...
namespace kalk
{
    internal static class DefaultExpressions
    {
        ...
        private static readonly ExtendedDictionary<string, Variable> Variables = new ExtendedDictionary<string, Variable>((value) => value.Identifier)
        {
            ...
            ( "da",         new MPFR(4, "10") ),
            ( "d",          new MPFR(1024, "0.1") ),
            ( "c",          new MPFR(1024, "0.01") ),
            ( "m",          new MPFR(1024, "0.001") ),
            ( "u",          new MPFR(1024, "0.000001") ),
            ( "n",          new MPFR(1024, "0.000000001") ),
            ( "p",          new MPFR(1024, "0.000000000001") ),
            ( "f",          new MPFR(1024, "0.000000000000001") ),
            ( "a",          new MPFR(1024, "0.000000000000000001") ),
            ( "z",          new MPFR(1024, "0.000000000000000000001") ),
            ( "y",          new MPFR(1024, "0.000000000000000000000001") ),

            ( "pc",         new MPFR(1024, "0.01") ),
            ( "pm",         new MPFR(1024, "0.001") ),
            ( "ptt",        new MPFR(1024, "0.0001") ),
            ( "ppm",        new MPFR(1024, "0.000001") ),
            ( "ppb",        new MPFR(1024, "0.000000001") ),
            ( "ppt",        new MPFR(1024, "0.000000000001") ),
            ( "ppq",        new MPFR(1024, "0.000000000000001") ),
            ...
            ( "phys.G",     new MPFR(1024, "0.00000000006674") ),
            ( "phys.g",     new MPFR(1024, "9.80665") ),
            ( "phys.R",     new MPFR(1024, "8.3144626181532") ),
        ...
        {
            ( "Y",          @"Yotta",                       @"SI prefix, 10^24" ),
            ( "Z",          @"Zetta",                       @"SI prefix, 10^21" ),
            ( "E",          @"Exa",                         @"SI prefix, 10^18" ),
            ( "P",          @"Peta",                        @"SI prefix, 10^15" ),
            ( "T",          @"Tera",                        @"SI prefix, 10^12" ),
            ( "G",          @"Giga",                        @"SI prefix, 10^9" ),
            ( "M",          @"Mega",                        @"SI prefix, 10^6" ),
            ( "k",          @"Kilo",                        @"SI prefix, 10^3" ),
            ( "h",          @"Hecto",                       @"SI prefix, 10^2" ),
            ( "da",         @"Deca",                        @"SI prefix, 10^1" ),
            ( "d",          @"Deci",                        @"SI prefix, 10^-1" ),
            ( "c",          @"Centi",                       @"SI prefix, 10^-2" ),
            ( "m",          @"Milli",                       @"SI prefix, 10^-3" ),
            ( "u",          @"Micro",                       @"SI prefix, 10^-6" ),
            ( "n",          @"Nano",                        @"SI prefix, 10^-9" ),
            ( "p",          @"Pico",                        @"SI prefix, 10^-12" ),
            ( "f",          @"Femto",                       @"SI prefix, 10^-15" ),
            ( "a",          @"Atto",                        @"SI prefix, 10^-18" ),
            ( "z",          @"Zepto",                       @"SI prefix, 10^-21" ),
            ( "y",          @"Yocto",                       @"SI prefix, 10^-24" ),

            ( "pc",         @"Percent",                     @"Parts-per notation, 10^-2" ),
            ( "pm",         @"Permille",                    @"Parts-per notation, 10^-3" ),
            ( "ptt",        @"Parts per ten thousand",      @"Parts-per notation, 10^-4" ),
            ( "ppm",        @"Parts per million",           @"Parts-per notation, 10^-6" ),
            ( "ppb",        @"Parts per billion",           @"Parts-per notation, 10^-9" ),
            ( "ppt",        @"Parts per trillion",          @"Parts-per notation, 10^-12" ),
            ( "ppq",        @"Parts per quadrillion",       @"Parts-per notation, 10^-15" ),
